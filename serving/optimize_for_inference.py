...
def parse_args():
  ...
  parser.add_argument(
      "--output",
      type=str,
      default="../model/inference_2.pb",
      help="File to save the output graph to.")
  parser.add_argument(
      "--input_names",
      type=str,
      default="data_pipeline/IteratorGetNext",
      help="Input node names, comma separated.")
  parser.add_argument(
      "--output_names",
      type=str,
      default="EfficentCornerNet/heat/conv2d/BiasAdd,EfficentCornerNet/offset/conv2d/BiasAdd",
